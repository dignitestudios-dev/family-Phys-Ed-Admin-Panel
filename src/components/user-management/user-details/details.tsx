    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="bg-secondary p-5 rounded-2xl">
        ...
        <div className="flex flex-wrap gap-4">
          {activity_preferences?.length ? (
            activity_preferences.map((act, idx) => (
              <div
                className="text-white w-[25%] text-center bg-[#2a2a2b] p-2 rounded-xl"
                key={idx}
              >
                {act}
              </div>
      ...
      <div className="bg-secondary p-5 rounded-2xl">
        ...
        {fitness_level ? (
          <div className="text-white w-[25%] text-center bg-[#2a2a2b] p-2 rounded-xl">
            {fitness_level}
          </div>
        ) : (
          <p className="text-gray-400 text-sm mt-5">
            No fitness level specified
          </p>
        )}
      </div>
    </div>
