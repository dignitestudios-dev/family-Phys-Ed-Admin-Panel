                                ...
                                <div key={idx} className="space-y-2">
                                    <div className="bg-[#2c2c2e] flex justify-between items-center p-2 rounded-2xl px-4" >
                                        <div className="flex gap-2 items-center">
                                            <Image className="rounded-full w-[50px] h-[50px]" src={`${process.env.NEXT_PUBLIC_MEDIA_URL}${b.avatar}`} alt="img" width={50} height={50} />

                                            <div> <h1 className="text-sm">{b.name}</h1>
