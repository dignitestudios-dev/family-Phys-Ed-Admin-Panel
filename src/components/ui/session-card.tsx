    ...
    <div className="bg-[#2C2C2E] p-2 w-[32.5%] text-white rounded-xl ">
      <div className="flex flex-col">
        ...
        <div className="flex justify-between py-2">
          <div>
            <h1>{session?.title}</h1>{" "}
            <h3 className="text-sm text-primary">{session?.activity}</h3>
          </div>
          <div>
            <h1 className="text-primary font-bold text-right">
              ${session?.amount}
            </h1>
        ...
        <div className="text-xs border-b pb-2">
          ...
          <h1 className="flex items-center gap-2">
            {" "}
            <MapPin className="text-primary" size={20} /> {session?.location}
          </h1>
        </div>
